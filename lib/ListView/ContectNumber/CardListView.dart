...
class CardListView extends StatelessWidget {
  ...
  //  masjid name
  List<String> Name = ['Masjid al-Haram ','Al-Masjid an-Nabawi','Sheikh Zayed Grand Mosque ','Sultan Ahmed Mosque','Al-Aqsa Mosque ','Hassan II Mosque','Nasir al-Mulk Mosque','Badshahi Mosque','Sultan Qaboos Grand Mosque ', 'Putra Mosque', 'Faisal Mosque'];
  // city name
  List<String> City = [' Makkah, Saudi Arabia 🕋','Madinah, Saudi Arabia 🌿','Abu Dhabi, UAE ✨',' Istanbul, Turkey 🏛️','Jerusalem, Palestine 🕊️',' Casablanca, Morocco 🌊','Shiraz, Iran 🎨',' Lahore, Pakistan 🕌','Muscat, Oman 🌟','Putrajaya, Malaysia 💖','Islamabad, Pakistan ⛰️'];
  // img list
